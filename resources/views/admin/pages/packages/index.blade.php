...
<x-bread-crumb :breadcrumbs="[
        ['text'=>'package','link'=>route('admin.package.index')],
        ['text'=> 'list']
        ]" :button="[]">
</x-bread-crumb>
@endsection
            ...
            <div class="card">
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        <!--begin::Toolbar-->
                        @adminCan('packages.create')
                        <!--end::Group actions-->
                        <a href="{{ route('admin.package.create') }}" class="btn btn-primary btn-sm">Add Package</a>
                        @endadminCan
                    </div>
                    <!--end::Card toolbar-->
                </div>
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                        ...
                        <tbody class="fw-bold text-gray-600">
                            ...
                            <tr>
                                ...
                                <!--begin::Email=-->
                                <td>
                                    <a href="#" class="text-gray-600 text-hover-primary mb-1">{{ $package->name }}</a>
                                </td>
                                <td>{{ $package->price }}</td>
                                <td>{{ $package->getCreatedAt() }}</td>
                                <td class="text-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                        @adminCan('packages.edit')
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <a href="{{ route('admin.package.edit',$package->id) }}" class="menu-link px-3">Edit</a>
                                        </div>
                                        <!--end::Menu item-->
                                        @endadminCan
                                        @adminCan('packages.delete')
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
