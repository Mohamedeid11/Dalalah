...
@section('crumb')
    <x-bread-crumb :breadcrumbs="[
        ['text'=>'Reviews' ],
        ['text'=>'Reported Reviews','link'=>route('admin.carPlates.ads')],
        ]" :button="[]">
    </x-bread-crumb>
@endsection
                    ...
                    <div class="card-body pt-0" style="overflow: auto;">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                            ...
                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-125px">Reported At</th>
                                <th class="min-w-125px">Ad Type</th>
                            ...
                            @if(count($reviews))
                                @foreach ($reviews as $review)
                                    <tr>
                                        ...
                                        <td>
                                            {{ $review?->user?->name ?? $review?->showroom?->name }}
                                        </td>
                                        <td>
                                            {{ $review->body }}
                                        </td>
                                        ...
                                        <td>
                                            @if($review->car_id != null)
                                                <button class="badge bg-success" style="border: transparent;"> Car Ad </button>
                                            @else
                                                <button class="badge bg-primary" style="border: transparent;"> Car Plate Ad</button>
                                            @endif
                                        </td>
                                        ...
                                        <td class="text-end">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="{{ route('admin.review.delete',$review->id) }}" class="menu-link px-3"> Delete </a>
                                                </div>
                                                <!--end::Menu item-->
                                                @endadminCan
