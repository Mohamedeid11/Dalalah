                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        ...
                        @adminCan('branches.create')
                            <!--end::Group actions-->
                            <a href="{{ route('admin.branch.create', ['showroom' => $showroom->id]) }}" class="btn btn-primary btn-sm">Add Branch</a>
                        @endadminCan
                    </div>
                    <!--end::Card toolbar-->
                </div>
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                        ...
                        <tbody class="fw-bold text-gray-600">
                            ...
                            <tr>
                                <!--begin::Email=-->
                                <td>
                                    <a href="#" class="text-gray-600 text-hover-primary mb-1">{{ $branche->name }}</a>
                                </td>
                                <td>
                                    {{ $branche->city->name }}
                                </td>
                                ...
                                <td class="text-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="{{ route('admin.branch.edit', ['showroom' => $showroom->id ,'branch' => $branche->id]) }}" class="menu-link px-3">Edit</a>
                                        </div>
                                        <!--end::Menu item-->
                                        @endadminCan
                                        ...
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <form action="{{ route('admin.branch.destroy',['showroom' => $showroom->id ,'branch' => $branche->id])}}" method="POST">
                                                @csrf
                                                @method('DELETE')
