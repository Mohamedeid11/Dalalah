...
<x-bread-crumb :breadcrumbs="[
        ['text'=>'Reports','link'=>route('admin.report.index')],
        ['text'=> 'list']
        ]" :button="[]">
</x-bread-crumb>
@endsection
            ...
            <div class="card">
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        <!--begin::Toolbar-->
                        @adminCan('reports.create')
                            <!--end::Group actions-->
                            <a href="{{ route('admin.report.create') }}" class="btn btn-primary btn-sm">Add report</a>
                        @endadminCan
                    </div>
                    <!--end::Card toolbar-->
                </div>
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                        ...
                        <tbody class="fw-bold text-gray-600">
                            ...
                            <tr>
                                ...
                                <!--begin::Email=-->
                                <td>
                                    <a href="#" class="text-gray-600 text-hover-primary mb-1">{{ $report->name }}</a>
                                </td>
                                <td>
                                    {{ $report->getCreatedAt() }}
                                </td>
                                <td class="text-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                        @adminCan('report_options.read')
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                                <a href="{{ route('admin.report_option.index',['report'=>$report->id]) }}" class="menu-link px-3">options</a>
                                            </div>
                                            <!--end::Menu item-->
                                        @endadminCan
                                        @adminCan('reports.edit')
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                                <a href="{{ route('admin.report.edit',$report->id) }}" class="menu-link px-3">Edit</a>
                                            </div>
                                            <!--end::Menu item-->
                                        @endadminCan
                                        @adminCan('reports.delete')
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
