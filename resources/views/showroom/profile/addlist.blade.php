                        ...
                        <div class="user-profile-card">
                            ...
                            <div class="col-lg-12">
                                <div class="add-listing-form">
                                    ...
                                    <form action="{{ route('showroom.store.car') }}" method="POST" id="add_car" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="branch_id" required>
                                                        <option value="">Choose</option>
                                                        @foreach (auth('showroom')->user()->branches as $branch)
                                            ...
                                            <input type="hidden" name="model_id" value="{{ auth('showroom')->user()->id }}">
                                            <input type="hidden" name="model_role" value="showroom">
